<?php
  ...
  //CAPABILITY
  $string['social_course:use_social_course'] = "Utilizar " . $string['pluginname'];

  //ERRORS AND API DEFAULT MESSAGE
  $string['invalid_api_data'] = 'Se han proporcionado datos invalidos para el servicio web';
