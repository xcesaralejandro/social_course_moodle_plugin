<?php 
  class local_social_course_comment{
    ...
    public static function get_comments($publicationid, $limit = null){
      ...
      global $DB;
      $sql = "select c.*, u.username, u.firstname, u.lastname, u.email, u.lastaccess from {user} u, 
              {sc_comments} c where u.id = c.sc_authorid and sc_publicationid = ? order by id desc";
